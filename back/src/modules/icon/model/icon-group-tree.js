...
var icon_group_1 = require("./icon-group");
var IconGroupTree = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return icon_group_1.IconGroup; }, function (o) { return o.children; }),
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return icon_group_1.IconGroup; }, function (o) { return o.parents; }),
        (0, typeorm_1.JoinColumn)({
            name: 'parent_seq_no'
        }),
        (0, graphql_1.Field)(function () { return icon_group_1.IconGroup; })
    ...
    IconGroupTree = __decorate([
        ...
        (0, graphql_1.ObjectType)('GqlIconGroupTree')
    ], IconGroupTree);
