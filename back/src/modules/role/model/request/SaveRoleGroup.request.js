...
var SaveRoleGroupRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, graphql_1.Field)(function () { return graphql_1.Int; }, {
            nullable: true,
            description: util_common_1.UtilCommon.getFieldComment('role', 'group', 'seqNo')
        })
    ...
    SaveRoleGroupRequest = __decorate([
        (0, graphql_1.InputType)({
            description: util_common_1.UtilCommon.getFieldComment('role', 'group', 'save', 'req')
        }),
        (0, graphql_1.ArgsType)()
    ], SaveRoleGroupRequest);
    return SaveRoleGroupRequest;
}((0, graphql_1.PickType)(RoleGroup_1.RoleGroup, ['name', 'parentSeqNo'])));
