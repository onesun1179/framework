...
var RoutesResolver = /** @class */ (function () {
    function RoutesResolver(routeService) {
        this.routeService = routeService;
    }
    RoutesResolver.prototype.rootRoutes = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.routeService.getRouteRepository().find({
                        where: {
                            parents: []
                        }
                    })];
    ...
    ], RoutesResolver.prototype, "rootRoutes");
    RoutesResolver = __decorate([
